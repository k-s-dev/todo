...
class ProjectApiMinimalSetupClass(CustomTestCaseSetup):
    ...
    def setUpTestData(cls):
        ...
        cls.view_name_list = "api:project-list"
        cls.view_name_detail = "api:project-detail"
    ...
    @classmethod
    def get_project_serializers(cls, pk_seq=None, cat_pk_seq=None):
...
class ProjectApiAuthAndCrudTests(ProjectApiFullSetupTestClass):
    ...
    def test_auth_required(self):
        ...
        response = self.client.get(reverse(
            self.view_name_list,
            kwargs={
                "ws_pk": self.cat_1_project_1.category.workspace.pk,
                "cat_pk": self.cat_1_project_1.category.pk,
            }))
    ...
    def test_project_get(self):
        ...
        cat_1_serializers = self.get_project_serializers(
            cat_pk_seq=[self.cat_1_project_1.category.pk])
...
class ProjectApiTreeTests(ProjectApiFullSetupTestClass):
    ...
    def test_create_post(self):
        ...
        url = reverse(self.view_name_list,
                      kwargs={
                          "ws_pk": self.cat_1_nested_project_1_1.category.workspace.pk,
                          "cat_pk": self.cat_1_nested_project_1_1.category.pk,
                      })
        response = self.client.post(url, data)
        retrieved_data = core_models.Project.objects.filter(
