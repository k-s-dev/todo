...
class PriorityApiMinimalSetupClass(CustomTestCaseSetup):
    ...
    def setUpTestData(cls):
        ...
        cls.view_name_list = "api:priority-list"
        cls.view_name_detail = "api:priority-detail"
    ...
    @classmethod
    def get_priority_serializers(cls, pk_seq=None, ws_pk_seq=None):
        priority_query = cls.get_priority_query(pk_seq, ws_pk_seq).order_by("id")
...
class PriorityApiAuthAndCrudTests(PriorityApiFullSetupTestClass):
    ...
    def test_auth_required(self):
        ...
        response = self.client.get(reverse(self.view_name_list,
                                           kwargs={"ws_pk": self.ws_1_priority_1.workspace.pk}))
    ...
    def test_priority_get(self):
        ...
        response_1 = self.client.get(reverse(self.view_name_detail, kwargs={
            "ws_pk": self.ws_1_priority_1.workspace.pk,
        ...
        ws_1_priority_serializers = self.get_priority_serializers(
            ws_pk_seq=[self.ws_1_priority_1.workspace.pk])
    ...
    def test_priority_create_post(self):
        ...
        retrieved_data = core_models.Priority.objects.filter(name="priority tmp")
