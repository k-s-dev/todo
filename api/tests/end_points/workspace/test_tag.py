...
class TagApiMinimalSetupClass(CustomTestCaseSetup):
    ...
    def setUpTestData(cls):
        ...
        cls.view_name_list = "api:tag-list"
        cls.view_name_detail = "api:tag-detail"
    ...
    @classmethod
    def get_tag_serializers(cls, pk_seq=None, ws_pk_seq=None):
        tag_query = cls.get_tag_query(pk_seq, ws_pk_seq).order_by("id")
...
class TagApiAuthAndCrudTests(TagApiFullSetupTestClass):
    ...
    def test_auth_required(self):
        ...
        response = self.client.get(reverse(self.view_name_list,
                                           kwargs={"ws_pk": self.ws_1_tag_1.workspace.pk}))
    ...
    def test_tag_get(self):
        ...
        response_1 = self.client.get(reverse(self.view_name_detail, kwargs={
            "ws_pk": self.ws_1_tag_1.workspace.pk,
        ...
        ws_1_tag_serializers = self.get_tag_serializers(
            ws_pk_seq=[self.ws_1_tag_1.workspace.pk])
